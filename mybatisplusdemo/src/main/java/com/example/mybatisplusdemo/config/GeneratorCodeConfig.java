...
//        ResourceBundle rb = ResourceBundle.getBundle("genreator");
        ...
        dsc.setUrl("jdbc:mysql://127.0.0.1:3306/ssm?serverTimezone=Asia/Shanghai&useUnicode=true&characterEncoding=utf-8&zeroDateTimeBehavior=convertToNull&useSSL=false");
        ...
        /** 需要生成的表*/
        strategy.setInclude(new String[]{"book"});
