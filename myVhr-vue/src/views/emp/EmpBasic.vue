...
export default {
  ...
  methods: {
    ...
    initPositions() {
      this.api.getRequest("/employee/basic/positions").then(resp => {
        if (resp) {
          this.positions = resp;
        }
      });
    ...
    getMaxWordID() {
      this.api.getRequest("/employee/basic/maxWorkID").then(resp => {
        if (resp) {
    ...
    initData() {
      if (!window.sessionStorage.getItem("nations")) {
        this.api.getRequest("/employee/basic/nations").then(resp => {
          if (resp) {
            this.nations = resp;
      ...
      if (!window.sessionStorage.getItem("joblevels")) {
        this.api.getRequest("/employee/basic/joblevels").then(resp => {
          if (resp) {
            this.joblevels = resp;
      ...
      if (!window.sessionStorage.getItem("politicsstatus")) {
        this.api.getRequest("/employee/basic/politicsstatus").then(resp => {
          if (resp) {
      ...
      if (!window.sessionStorage.getItem("deps")) {
        this.api.getRequest("/employee/basic/deps").then(resp => {
          if (resp) {
            this.allDeps = resp;
    ...
    initEmps(type) {
      ...
      this.api.getRequest(url).then(resp => {
        this.loading = false;
        if (resp) {
          this.emps = resp.data;
