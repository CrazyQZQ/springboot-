    ...
    export default {
        ...
        methods: {
            ...
            initSelectedMenus(rid) {
                this.api.getRequest("/system/basic/permiss/mids/" + rid).then(resp => {
                    if (resp) {
            ...
            initAllMenus() {
                this.api.getRequest("/system/basic/permiss/menus").then(resp => {
                    if (resp) {
                        this.allmenus = resp;
                    }
                })
            ...
            initRoles() {
                this.loading = true;
                this.api.getRequest("/system/basic/permiss/").then(resp => {
                    this.loading = false;
                    if (resp) {
                        this.roles = resp;
                    }
